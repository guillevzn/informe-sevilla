import os
os.chdir(r'/Users/guille/Documents/GitHub/informe-sevilla')
...
#os.system('Jupyter nbconvert Informe_de_Coyuntura_del_Municipio_de_Sevilla.ipynb --to pdf --no-input --no-prompt')
